...
def initialize(arguments=None):
    if arguments is None:
        arguments = Munch({'config': 'LatexOCR/settings/config.yaml', 'checkpoint': 'checkpoints/weights.pth', 'no_cuda': True, 'no_resize': False})
...
def latexocr(img_path): 
    ...
    parser.add_argument('-c', '--config', type=str, default='LatexOCR/settings/config.yaml')
    parser.add_argument('-m', '--checkpoint', type=str, default='LatexOCR/checkpoints/weights.pth')
